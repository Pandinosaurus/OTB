...
PolyLineParametricPathWithValue<TValue, VDimension>::PolyLineParametricPathWithValue()
...
template <class TValue, unsigned int VDimension>
void PolyLineParametricPathWithValue<TValue, VDimension>::AddVertex(const ContinuousIndexType& vertex)
{
...
template <class TValue, unsigned int VDimension>
double PolyLineParametricPathWithValue<TValue, VDimension>::GetLength() const
{
  if (!m_LengthIsValid)
  {
    ComputeLength();
...
template <class TValue, unsigned int VDimension>
void PolyLineParametricPathWithValue<TValue, VDimension>::ComputeLength() const
{
  double                      length = 0.0;
 ...
 */
template <class TValue, unsigned int VDimension>
void PolyLineParametricPathWithValue<TValue, VDimension>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
...
template <class TValue, unsigned int                                     VDimension>
typename PolyLineParametricPathWithValue<TValue, VDimension>::RegionType PolyLineParametricPathWithValue<TValue, VDimension>::GetBoundingRegion() const
{
 ...
 */
template <class TValue, unsigned int VDimension>
void PolyLineParametricPathWithValue<TValue, VDimension>::ComputeBoundingRegion() const
{
  SizeType  size;
  IndexType index;
...
template <class TValue, unsigned int VDimension>
void PolyLineParametricPathWithValue<TValue, VDimension>::Modified() const
{
